...
$sql = "SELECT unseen FROM InvestorArray WHERE user = '$username'";
...
if ($result->num_rows > 0) {
  ...
  $num = $count;
    if ($num==0) {
     ...
     <span onclick="window.location.href='/login_testing/InvestorHome.php'" class="w3-button w3-xlarge w3-transparent w3-right" title="Close Modal" style="font-size: 40px">×</span>
    ...
    <div id="buttons" class="hideDiv">  
        <form method="post" action="iupdate2.php"> 
