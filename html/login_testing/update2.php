<?php
      ...
      //liked 
        $sql = "SELECT liked FROM StartupArray WHERE user = '$username'";
        $result = mysqli_query($db,$sql);
          ...
          $row = mysqli_fetch_assoc($result);
              ...
              if (in_array("$value", $liked2, TRUE)) 
                ...
                { 
                  ...
                  $sql2 = "UPDATE StartupArray SET liked = '$liked' WHERE user = '$username'";
                  $result = mysqli_query($db,$sql2);
                  $num--;
                } 
          } else {
      ...
      //favorite/heart
        $sql = "SELECT favorite FROM StartupArray WHERE user = '$username'";
        $result = mysqli_query($db,$sql);
        if ($result->num_rows > 0) {
          // output data of each row
          $row = mysqli_fetch_assoc($result);
              ...
              if (in_array("$value", $favorite2, TRUE)) 
                ...
                { 
                  ...
                  $sql2 = "UPDATE StartupArray SET favorite = '$favorite' WHERE user = '$username'";
                  $result = mysqli_query($db,$sql2);
                  $num--;
                  $x =0;
                } 
      ...
      //favorite/heart
        $sql = "SELECT unliked FROM StartupArray WHERE user = '$username'";
        $result = mysqli_query($db,$sql);
        if ($result->num_rows > 0) {
          // output data of each row
          $row = mysqli_fetch_assoc($result);
              ...
              if (in_array("$value", $unliked2, TRUE)) 
                ...
                { 
                  ...
                  $sql2 = "UPDATE StartupArray SET unliked = '$unliked' WHERE user = '$username'";
                  $result = mysqli_query($db,$sql2);
                  $num--;
                } 
          } else {
